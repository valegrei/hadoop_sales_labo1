...
public class MinMaxDriver {
	public static void main(String[] args) throws Exception {
		...
		Job job1 = Job.getInstance(conf, "subtotales");

		job1.setJarByClass(MinMaxDriver.class);
		job1.setMapperClass(SubtotalMapper.class);
		job1.setReducerClass(SubtotalReducer.class);
